...
favoriteButton.addEventListener('click', function () {
    ...
    if (popupOn.innerHTML == "") {
        ...
        popupOn.innerHTML = "<section><h2>Verhaal 'Repcept' is nu in jouw favorieten bewaard!</h2><p>Dit verhaal downloaden als PDF?<p> <a href='images/Verhaal-Recept.pdf'download><button>Downloaden <i class='fas fa-download'></i></button></a></section>";
    } else {
        popupOn.innerHTML = "";
    }
